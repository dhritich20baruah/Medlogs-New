...
const BloodSugarInfo = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.text}>
        Values:
        {"\n"}- <Text style={{color: "green"}}>Normal:</Text> Less than 100 mg/dL (5.6 mmol/L)
        {"\n"}- <Text style={{color: "orange"}}>Prediabetes:</Text> 100-125 mg/dL (5.6-6.9 mmol/L)
        {"\n"}- <Text style={{color: "red"}}>Diabetes:</Text> 126 mg/dL (7.0 mmol/L) or higher on two separate tests
      </Text>
      ...
      <Text style={styles.text}>
        Values:
        {"\n"}- <Text style={{color: "green"}}>Normal:</Text> Less than 140 mg/dL (7.8 mmol/L)
        {"\n"}- <Text style={{color: "orange"}}>Prediabetes:</Text> 140-199 mg/dL (7.8-11.0 mmol/L)
        {"\n"}- <Text style={{color: "red"}}>Diabetes:</Text> 200 mg/dL (11.1 mmol/L) or higher
      </Text>
      ...
      <Text style={styles.text}>
        Values:
        {"\n"}- <Text style={{color: "green"}}>Normal:</Text> Less than 200 mg/dL (11.1 mmol/L)
        {"\n"}- <Text style={{color: "red"}}>Diabetes:</Text> 200 mg/dL (11.1 mmol/L) or higher, especially if accompanied by symptoms of diabetes (such as increased thirst, urination, and fatigue)
      </Text>
